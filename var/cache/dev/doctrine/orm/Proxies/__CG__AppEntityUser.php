...
class User extends \App\Entity\User implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'buy' => [parent::class, 'buy', null],
        ...
        "\0".parent::class."\0".'telefone' => [parent::class, 'telefone', null],
        'Name' => [parent::class, 'Name', null],
        'buy' => [parent::class, 'buy', null],
        ...
        'telefone' => [parent::class, 'telefone', null],
    ];
