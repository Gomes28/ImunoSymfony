 ...
 */
class getSecurity_Firewall_Map_Context_FrontService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.firewall.map.context.front' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.firewall.map.context.front'])) {
            return $container->privates['security.firewall.map.context.front'];
        }
        ...
        return $container->privates['security.firewall.map.context.front'] = new \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext(new RewindableGenerator(function () use ($containerRef) {
