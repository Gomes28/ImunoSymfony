...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.MgBRCFL'] ?? self::get_ServiceLocator_MgBRCFLService($container)), ($container->privates['.service_locator.9R_5lv1'] ?? $container->load('get_ServiceLocator_9R5lv1Service')), ['front' => [($container->privates['security.authenticator.form_login.front'] ?? $container->load('getSecurity_Authenticator_FormLogin_FrontService'))], 'admin' => [($container->services['App\\Security\\AppAdminAuthenticator'] ?? $container->load('getAppAdminAuthenticatorService'))]], false);
