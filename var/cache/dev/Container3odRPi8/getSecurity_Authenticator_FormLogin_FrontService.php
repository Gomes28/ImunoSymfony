 ...
 */
class getSecurity_Authenticator_FormLogin_FrontService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.authenticator.form_login.front' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authenticator.form_login.front'])) {
            return $container->privates['security.authenticator.form_login.front'];
        }
        ...
        $c->setOptions(['login_path' => 'app_user_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false]);
        $c->setFirewallName('front');
