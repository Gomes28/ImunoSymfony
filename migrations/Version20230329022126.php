 ...
 */
final class Version20230329022126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE return_mp (id INT AUTO_INCREMENT NOT NULL, dados_mp JSON DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE school_vacin (id INT AUTO_INCREMENT NOT NULL, school_id_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_B9742DC6A1BE284D (school_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE school_vacin ADD CONSTRAINT FK_B9742DC6A1BE284D FOREIGN KEY (school_id_id) REFERENCES buy_vacin (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE return_mp');
        $this->addSql('DROP TABLE school_vacin');
